...
<head>
    ...
    <link href="<?php echo get_stylesheet_directory_uri(); ?>/assets/lib/lightbox/css/lightbox.min.css" rel="stylesheet">
...
<body>
    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse navbarjs" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="/gallery_" class="dropdown-item">Our Gallery</a>
                            <a href="/guides" class="dropdown-item">Travel Guides</a>
                            <a href="/testimonals" class="dropdown-item">Testimonial</a>
                            <a href="/404" class="dropdown-item">404 Page</a>
                        </div>
                    </div>
                    <a href="/contact" class="nav-item nav-link">Contact</a>
                </div>
                <a href="/package" class="btn btn-primary rounded-pill py-2 px-4 ms-lg-4">Book Now</a>
            </div>
        </nav>

        <script>
            var element = document.getElementsByClassName("navbarjs")[0];
            console.log(element);
